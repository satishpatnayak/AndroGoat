...
import owasp.sat.agoat.databinding.ActivityClipboardBinding
import java.util.*
...
class ClipboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityClipboardBinding.inflate(layoutInflater)
        setContentView(binding.root)
        val ccValue=findViewById<EditText>(R.id.cc)

        binding.verifyCC.setOnClickListener{
